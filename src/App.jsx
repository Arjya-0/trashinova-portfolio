...
const TrashinovaApp = () => {
  ...
  const teamMembers = [
    { 
      ...
      bio: "Handling data analysis, technical support, and web development for the ORCA project. Building digital infrastructure for space exploration.",
    ...
    { 
      ...
      bio: "Leading the ORCA team and conducting primary research on Mars habitat recycling systems and waste management technologies.",
    ...
    { 
      ...
      bio: "Creating compelling content and documentation for ORCA project communications and research presentations.",
    ...
    { 
      ...
      bio: "Designing and prototyping ORCA system components using advanced CAD modeling for Mars habitat applications.",
    ...
    { 
      ...
      bio: "Creating visual animations and video content to showcase ORCA technologies and project documentation.",
